# -*- coding: utf-8 -*-
#
# Spatial Database Tips and Tricks build configuration file, created by
# sphinx-quickstart on Wed Oct 29 21:02:45 2008.
#
...
project = u'Spatial Database Tip and Tricks'
...
#html_static_path = [ theme_dir + '/_static']
